...
- Name: tests\e2e\biblioteca.spec.ts >> 🔐 BIBLIOTECA VIRTUAL - Testes de Segurança >> Teste 02: Access Control - Limite de Empréstimos >> 🔒 Deve permitir renovação de empréstimo sem contar limite
- Location: tests\e2e\biblioteca.spec.ts:142:9
...
Call log:
  - waiting for locator('button:has-text("Renovar")')
...
```yaml
- generic [ref=e2]: Cannot GET /biblioteca/meus-emprestimos
```
