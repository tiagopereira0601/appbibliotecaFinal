...
- Name: tests\e2e\auth-security.spec.ts >> 🔐 AUTENTICAÇÃO & SISTEMA - Testes de Segurança >> Teste 07: Password Validation - Força de Senha >> 🔐 Deve aceitar senhas fortes
- Location: tests\e2e\auth-security.spec.ts:164:9
...
- generic [ref=e2]:
  ...
  - generic [ref=e4]:
    - textbox "Email" [ref=e5]: newuser2@test.com
    - textbox "Senha" [active] [ref=e6]: SecurePassword@2024
    - generic [ref=e7]:
