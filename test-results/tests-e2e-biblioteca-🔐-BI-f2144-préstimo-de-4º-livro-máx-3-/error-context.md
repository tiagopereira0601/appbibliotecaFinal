...
- Name: tests\e2e\biblioteca.spec.ts >> 🔐 BIBLIOTECA VIRTUAL - Testes de Segurança >> Teste 02: Access Control - Limite de Empréstimos >> 🔒 Deve bloquear empréstimo de 4º livro (máx 3)
- Location: tests\e2e\biblioteca.spec.ts:94:9
...
Call log:
  - waiting for locator('button:has-text("O Quinto Elemento")')
...
```yaml
- generic [ref=e2]: Cannot GET /biblioteca
```
