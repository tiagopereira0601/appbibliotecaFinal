...
- Name: tests\e2e\biblioteca.spec.ts >> 🔐 BIBLIOTECA VIRTUAL - Testes de Segurança >> Teste 05: Data Integrity - Sincronização Mobile ↔ Web >> 🔄 Deve detectar dados corrompidos
- Location: tests\e2e\biblioteca.spec.ts:369:9
